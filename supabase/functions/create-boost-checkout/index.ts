...
serve(async (req) => {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      line_items: [
        {
          price: "price_1T1uDTRnrCLBBVkPYcOYLAbW",
          quantity: 1,
        },
      ],
      mode: "payment",
      success_url: `${origin}/services/${serviceId}?boosted=true&session_id={CHECKOUT_SESSION_ID}`,
      cancel_url: `${origin}/services/${serviceId}`,
      metadata: {
