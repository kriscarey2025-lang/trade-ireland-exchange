  ...
  return <Link to={buildServiceUrl(service.title, service.id)} className="block h-full">
      <Card className={cn(
        ...
        <CardContent className="p-4 sm:p-5 flex-1 flex flex-col">
          ...
          {/* Service Image - after title */}
          {hasImage && (
            <div 
              className="relative w-full overflow-hidden bg-muted rounded-lg mb-3 aspect-[16/10] sm:aspect-[16/9]"
                      ...
                      <div className="flex items-center gap-1 ml-1">
                        ...
                        {service.user.linkedinUrl && (
                          <a 
                            ...
                            className="hover:opacity-70 transition-opacity"
                          >
                            <Linkedin className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-brand-linkedin shrink-0" />
                          </a>
                        )}
                        {service.user.facebookUrl && (
                          <a 
                            ...
                            className="hover:opacity-70 transition-opacity"
                          >
                            <Facebook className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-brand-facebook shrink-0" />
                          </a>
                        )}
                        {service.user.instagramUrl && (
                          <a 
                            ...
                            className="hover:opacity-70 transition-opacity"
                          >
                            <Instagram className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-brand-instagram shrink-0" />
                          </a>
                        )}
                      </div>
                    )}
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-48">
                ...
                <DropdownMenuItem onClick={handleShareWhatsApp} className="cursor-pointer gap-2">
                  <svg className="h-4 w-4 text-brand-whatsapp" viewBox="0 0 24 24" fill="currentColor">
