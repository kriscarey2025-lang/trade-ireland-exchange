...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({
  className,
  ...props
}, ref) => <div ref={ref} className={cn("rounded-2xl border border-border/60 bg-gradient-card text-card-foreground shadow-medium backdrop-blur-sm transition-shadow duration-300 hover:shadow-elevated", className)} {...props} />);
