...
import { Loader2, MapPin, Sparkles, Search, Plus, X, ArrowRight } from "lucide-react";
...
export function OnboardingQuestionnaire() {
  ...
  const handleSubmit = async () => {
    ...
    toast.success("Preferences saved! Let's find you some matches.");
    navigate("/");
  };
      ...
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">
            Tell us a bit about yourself so we can help you find great matches.
          </p>
        </div>
