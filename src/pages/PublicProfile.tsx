  ...
  const { data: profile, isLoading: profileLoading, error: profileError } = useQuery({
    ...
    queryFn: async () => {
      ...
      const { data, error } = await supabase
        .rpc('get_public_profile', { _profile_id: id });
      ...
      return {
        ...data[0],
        verification_status: (data[0].verification_status as VerificationStatus) || 'unverified',
      } as PublicProfile;
    },
                ...
                <div>
                  ...
                  <div className="flex flex-wrap items-center gap-3 mt-2 text-sm text-muted-foreground">
                    ...
                    <span className="flex items-center gap-1">
                      ...
                      Member since {format(new Date(profile.registered_at), 'MMM yyyy')}
                    </span>
                  </div>
                  {/* Rating display */}
                  {stats?.avgRating && (
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  {profile.linkedin_url && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 px-3 py-2 rounded-lg bg-brand-linkedin/10 text-brand-linkedin hover:bg-brand-linkedin/20 transition-colors text-sm font-medium"
                    >
                  ...
                  {profile.facebook_url && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 px-3 py-2 rounded-lg bg-brand-facebook/10 text-brand-facebook hover:bg-brand-facebook/20 transition-colors text-sm font-medium"
                    >
                  ...
                  {profile.instagram_url && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 px-3 py-2 rounded-lg bg-brand-instagram/10 text-brand-instagram hover:bg-brand-instagram/20 transition-colors text-sm font-medium"
                    >
